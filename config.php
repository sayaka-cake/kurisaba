...
/******************************************************************************************************/
	...
	// Настройки базы данных
		...
		$cf['KU_DBHOST']          = 'mysql:3306'; // Хостнейм базы. На SQLite игнорируется.
		$cf['KU_DBDATABASE']      = 'kurisa_ch';  // Имя базы или путь к файлу базы для SQLite.
		$cf['KU_DBUSERNAME']      = 'root';   // Имя пользователя. На SQLite игнорируется.
	...
	// Пути. Скорее всего менять не потребуется.
		...
		$cf['KU_PROTO']             = 'http://';                            // Протокол - http или https (с двумя завершающими слэшами).
